...
text = text.replace(
    '<a href="https://www.britannica.com/place/Oregon-Illinois" class="md-crosslink">Oregon</a>',
    "",
)
text = text.replace(
    '<a href="https://www.britannica.com/place/Washington-North-Carolina" class="md-crosslink">Washington</a>',
    "",
)
text = text.replace(
    '<a href="https://www.britannica.com/place/Washington-Pennsylvania" class="md-crosslink">Washington</a>',
    "",
)
text = text.replace(
    '<a href="https://www.britannica.com/place/Washington-Georgia" class="md-crosslink">Washington</a>',
    "",
)
text = text.replace(
    '<a href="https://www.britannica.com/place/Virginia-Minnesota" class="md-crosslink">Virginia</a>',
    "",
)
...
for i in range(0, len(states)):
    if states[i] != "Wyoming":
        state_string = text[
            text.find('crosslink">' + states[i] + "<") : text.find(
                'crosslink">' + states[i + 1] + "<"
            )
        ]
    else:
